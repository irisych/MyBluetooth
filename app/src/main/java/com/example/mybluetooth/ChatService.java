...
public class ChatService {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Notification.MessagingStyle.Message msg = mHandler.obtainMessage(BluetoothChat.MESSAGE_DEVICE_NAME);
    ...
    private void connectionFailed() {
        setState(STATE_LISTEN);
        Notification.MessagingStyle.Message msg = mHandler.obtainMessage(BluetoothChat.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
